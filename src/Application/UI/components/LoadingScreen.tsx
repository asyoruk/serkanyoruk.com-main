        ...
        >
                    ...
                    >
                        <div style={styles.logoContainer}>
                            <div>
                                ...
                                <p style={styles.green}>
                                    <b>Ahmet Serkan Inc.</b>
                                </p>
                            </div>
                        </div>
                        <div style={styles.headerInfo}>
                            <p>Released: 02/05/1993</p>
                            <p>HHBIOS (C)1993 Yoruk Ahmet Serkan Inc.,</p>
                        </div>
                    </div>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Ahmet Serkan Yoruk Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Ahmet Serkan Yoruk Portfolio Showcase 2025</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
